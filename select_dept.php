...
<h style="background-color:black;color:orange;font-size:20px;">LIST ACCORDING TO DEPARTMENT</h>
<p style="font-size:20px;">
<?php
// Create connection
$conn = new mysqli("localhost", "root", "","StudDB");
// Check connection
$sql = "SELECT Name,Roll,Email,Address,About FROM StudReg WHERE Dept='$_GET[dept]'";
