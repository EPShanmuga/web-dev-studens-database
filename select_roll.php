...
<h style="background-color:black;color:orange;font-size:20px;">LIST ACCORDING TO ROLL NUMBER</h>
<p style="font-size:20px;">
<?php
// Create connection
$conn = new mysqli("localhost", "root", "","StudDB");
// Check connection
$sql = "SELECT Name,Roll,Dept,Email,Address,About FROM StudReg ORDER BY Roll";
